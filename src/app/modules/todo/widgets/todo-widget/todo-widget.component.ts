...
@Component({
  ...
  standalone: true,
  imports: [FormItemComponent, TodoHeaderBarUiComponent, SwipeComponent, CategoryListItemUiComponent, TodoListUiComponent, AsyncPipe, CategoryFilterPipe, TodoPipe,]
})
export class TodoWidgetComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.todoStore$.pipe(select(todoListSelector)).subscribe(i => console.log(i))
    this.todoStore$.pipe(select(categoriesListSelector)).subscribe(i => console.log(i))
  }
